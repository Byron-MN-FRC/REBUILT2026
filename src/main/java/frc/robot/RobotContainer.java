...
import static frc.robot.Constants.LEDConstants.LED_LENGTHS;
...
public class RobotContainer {
    ...
    SmartDashboard.putData("ClimbRaiseAuto", new ClimbRaiseAuto(m_climb));
    SmartDashboard.putData("ClimbLowerAuto", new ClimbLowerAuto(m_climb));

        // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=SMARTDASHBOARD
    SmartDashboard.putData("Climb", new Climb(m_climb));
    SmartDashboard.putData("Zeroing", new ClimbZeroing(m_climb));
    ...
    private void configureBindings() {
        ...
        final JoystickButton climb = new JoystickButton(accessory, XboxController.Button.kY.value);        
        climb.onTrue(new Climb(m_climb).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

        final JoystickButton climbZero = new JoystickButton(accessory, XboxController.Button.kB.value);        
        climbZero.onTrue(new ClimbZeroing(m_climb).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
