...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        SmartDashboard.putData("Climb", new Climb(m_climb,m_leds,m_hopper,m_turret));
    ...
    private void configureBindings() {
        ...
        accessory.a().onTrue(new Climb(m_climb, m_leds, m_hopper, m_turret).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
