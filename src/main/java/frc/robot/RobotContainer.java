...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        final JoystickButton fuelGrabButton = new JoystickButton(accessory, XboxController.Button.kX.value);        
        fuelGrabButton.whileTrue(new FuelGRAB(m_hopper).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
        final JoystickButton hopper1Button = new JoystickButton(accessory, XboxController.Button.kA.value);      //DUPLICATE FROM MERGE  
        hopper1Button.onTrue(new Extend(m_hopper).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
        final JoystickButton hopper2Button = new JoystickButton(accessory, XboxController.Button.kB.value);        //DUPLICATE FROM MERGE  
