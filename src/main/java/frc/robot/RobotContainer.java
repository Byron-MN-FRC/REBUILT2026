...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        SmartDashboard.putData("Climb", new ClimbCommand(m_climb,m_leds,m_hopper));
    ...
    private void configureBindings() {
        ...
        accessory.a().onTrue(new ClimbCommand(m_climb, m_leds, m_hopper).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
