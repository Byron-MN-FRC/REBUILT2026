...
public class DriveToPosition extends Command {
    ...
    private String _limelightName = Constants.VisionConstants.LIMELIGHT_NAME;
    ...
    public void initialize() {
        // TODO modify to take goal pose from the constructor
        goalPose = TagApproaches.getInstance().DesiredRobotPos(Vision.getInstance().lastAllignmentTarget);
