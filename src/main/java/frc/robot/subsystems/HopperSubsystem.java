    ...
    */
    public HopperSubsystem() {
        ...
        if (Constants.Debug.INTAKE_ROLLER_EXISTS) {
            ...
            SparkMaxConfig fuelGrabberConfig = new SparkMaxConfig();

            fuelGrabberConfig.smartCurrentLimit(10); // Limit gate motor current to 10 A
            fuelGrabberConfig.openLoopRampRate(0.25);
            leftFuelGrabber.configure(fuelGrabberConfig, ResetMode.kResetSafeParameters,
