...
public class Shooter extends SubsystemBase {
  ...
  public ShooterState currentShooterState = ShooterState.off;
  ...
  public void periodic() {
    ...
    if (currentShooterState == ShooterState.shooting) {
      if (isAtTargetRPM()) {
        openGates(openGatesSpeed);
        targetRPM = DistanceVelocityMap.getVelocity(TurretCam.getDistance());
      } else {
        stopGates();
      }
    } else if (currentShooterState == ShooterState.idle) {
      idlingState();
    }
  ...
  public void idlingState() {
    if (currentShooterState == ShooterState.idle) {
      leftShoot.set(Constants.ShooterConstants.SHOOTER_IDLE_SPEED);
    }
  }
