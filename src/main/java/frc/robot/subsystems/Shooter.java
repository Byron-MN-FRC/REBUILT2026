...
public class Shooter extends SubsystemBase {
  ...
  public Shooter() {
    ...
    leftShoot = new TalonFX(1, "rio");

    shooterGateLeft = new SparkMax(17, com.revrobotics.spark.SparkLowLevel.MotorType.kBrushless);
    shooterGateRight = new SparkMax(18, com.revrobotics.spark.SparkLowLevel.MotorType.kBrushless);
