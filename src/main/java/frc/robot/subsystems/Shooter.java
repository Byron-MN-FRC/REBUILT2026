...
public class Shooter extends SubsystemBase {
  ...
  public Shooter() {
    ...
    shooterGate.configure(gateConfigLeft, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    shooterMagazine.configure(gateConfigRight, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
