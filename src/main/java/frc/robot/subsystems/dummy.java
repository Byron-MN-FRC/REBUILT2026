...
public class dummy extends SubsystemBase {
    ...
    public void periodic() {
        ...
        if (Robot.getInstance().m_climb.currentLockdownMode == LockdownMode.partial) { //there is only a difference between partial and full if you are the wheels because the wheels need to move in partial but not full
